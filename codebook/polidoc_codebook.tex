...
\author{
\small
Prepared by the Polidoc.net Team \\ \small
 headed by Thomas Bräuninger (University of Mannheim), \\ \small
...
\begin{figure}[ht]
	\centering
		\includegraphics[width=1\textwidth, angle=90]{pt_nat.eps}
\end{figure}
...
\begin{figure}[ht]
	\centering
		\includegraphics[width=1\textwidth, angle=90]{nl_reg.eps}
\end{figure}

\begin{figure}[ht]
	\centering
		\includegraphics[width=1\textwidth, angle=90]{se_reg.eps}
\end{figure}
